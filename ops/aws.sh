...
sudo scp -r /Users/alan.poon/srv/ ubuntu@ec2-13-250-126-217.ap-southeast-1.compute.amazonaws.com:~
mkdir game_client
sudo scp -r nat-example/public ubuntu@ec2-13-250-126-217.ap-southeast-1.compute.amazonaws.com:~/
...
WASMCLOUD_CTL_HOST=13.250.126.217 REMOTE=13.250.126.217 WASMCLOUD_RPC_HOST=13.250.126.217 make build_aws
